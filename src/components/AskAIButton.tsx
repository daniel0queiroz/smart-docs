...
import React, { Fragment, startTransition, useRef, useState, useTransition } from "react";
    ...
    <Dialog open={open} onOpenChange={handleOnOpenChange}>
      <form>
        <DialogTrigger asChild>
          <Button variant="secondary">Pergunte à IA</Button>
        </DialogTrigger>
        <DialogContent className="custom-scrollbar flex h-[85vh] max-w-4xl flex-col overflow-y-auto" ref={contentRef}>
          <DialogHeader>
            <DialogTitle>Pergunte à IA sobre suas anotações</DialogTitle>
            <DialogDescription>
              Nossa IA responde perguntas referentes a todas as suas anotações
            </DialogDescription>
          </DialogHeader>
          ...
          >
            <Textarea 
            ref={textareaRef}
            placeholder="Pergunte-me qualquer informação sobre suas anotações"
